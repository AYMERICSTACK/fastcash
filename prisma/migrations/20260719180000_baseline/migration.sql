...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PREPARING', 'READY_FOR_PICKUP', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_prestashopId_key" ON "Product"("prestashopId");
...
-- CreateIndex
CREATE INDEX "Product_prestashopId_idx" ON "Product"("prestashopId");
