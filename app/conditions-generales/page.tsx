...
export default function TermsPage() {
  return <LegalPage eyebrow="Vente en ligne" title="Conditions générales de vente" intro="Ces conditions encadrent les achats réalisés sur la plateforme FAST CASH Genève. Elles devront être validées avec le commerçant avant l'ouverture officielle.">
    ...
    <p className="legal-note"><strong>À valider avant publication :</strong> ces conditions constituent une base opérationnelle et doivent être relues avec Nouredine, notamment pour les délais, garanties, retours et transporteurs.</p>
